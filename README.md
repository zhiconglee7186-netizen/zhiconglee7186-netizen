...
- Building scalable web applications with better engineering standards
- Connecting frontend products with backend services and AI workflows
- Exploring AI-native product development and automation pipelines
- Improving development efficiency through reusable systems and tooling
...
- Email: zhiconglee7186@email.com
- GitHub: (https://github.com/zhiconglee7186-netizen)
